...
extern "C" {
    pub fn UpdatePlayerInput(
        playerInput: PlayerInput,
        playerIndex: ::std::os::raw::c_int,
    ) -> RLBotCoreStatus;
}
extern "C" {
    pub fn UpdateFieldInfo(pFieldInfo: *mut FieldInfo) -> RLBotCoreStatus;
}
extern "C" {
    pub fn UpdateLiveDataPacket(pLiveData: *mut LiveDataPacket) -> RLBotCoreStatus;
}
extern "C" {
    pub fn SetGameState(
        gameTickPacket: *mut ::std::os::raw::c_void,
        protoSize: ::std::os::raw::c_int,
        callback: CallbackFunction,
        pID: *mut ::std::os::raw::c_uint,
    ) -> RLBotCoreStatus;
